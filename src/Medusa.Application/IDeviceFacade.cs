...
public interface IDeviceFacade
{
    ...
    Task<IReadOnlyCollection<DeviceModel>> GetDevicesAsync(CancellationToken cancellationToken = default);
    ...
    Task<DeviceModel?> GetDeviceAsync(Guid deviceId, CancellationToken cancellationToken = default);
    ...
    Task<DeviceModel> CreateDeviceAsync(CreateDeviceModel createDeviceModel, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token to observe while waiting for the task to complete.</param>
    Task UpdateDeviceAsync(Guid deviceId, UpdateDeviceModel updateDeviceModel, CancellationToken cancellationToken = default);
    ...
    Task<IReadOnlyCollection<DeviceActivityModel>> GetDeviceActivitiesAsync(Guid deviceId, CancellationToken cancellationToken = default);
    ...
    Task<DeviceActivityModel?> GetDeviceActivityAsync(Guid deviceId, Guid deviceActivityId, CancellationToken cancellationToken = default);
    ...
    Task<DeviceActivityModel> CreateDeviceActivityAsync(Guid deviceId, CreateDeviceActivityModel createDeviceActivityModel, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token to observe while waiting for the task to complete.</param>
    /// <returns>A boolean indicating whether the deletion was successful.</returns>
    Task<bool> DeleteDeviceActivityAsync(Guid deviceId, Guid deviceActivityId, CancellationToken cancellationToken = default);
}
